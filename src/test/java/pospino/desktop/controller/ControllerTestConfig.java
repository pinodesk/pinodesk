...
@ComponentScan({ "pospino.desktop.repository", "pospino.desktop.service", "pospino.desktop.properties" })
@EnableTransactionManagement
@EnableJdbcRepositories
@EnableJdbcAuditing
@PropertySource({ "classpath:application-test.properties" })
public class ControllerTestConfig extends AbstractJdbcConfiguration {
