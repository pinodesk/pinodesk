...
(null, current_timestamp, current_timestamp, NULL, 'DUS', 'Kardus'),
(null, current_timestamp, current_timestamp, NULL, 'BTL', 'Bottle'),
(null, current_timestamp, current_timestamp, NULL, 'CAPS', 'Capsule'),
(null, current_timestamp, current_timestamp, NULL, 'TAB', 'Tablet'),
(null, current_timestamp, current_timestamp, NULL, 'TUB', 'Tube'),
(null, current_timestamp, current_timestamp, NULL, 'AMP', 'Ampoule'),
(null, current_timestamp, current_timestamp, NULL, 'CAN', 'Kaleng'),
(null, current_timestamp, current_timestamp, NULL, 'BUNDLE', 'Bundle'),
(null, current_timestamp, current_timestamp, NULL, 'PACK', 'Pack'),
(null, current_timestamp, current_timestamp, NULL, 'SUPP', 'Suppository'),
