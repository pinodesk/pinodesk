...
import pospino.desktop.service.api.PospinoApiService;
import pospino.desktop.util.DeviceUtils;
...
public class ActivationController extends CommonDataSaveController {
    ...
    private PospinoApiService pospinoApiService;
    ...
    protected Object save() {
        ...
        ActivateReleaseResponse response = pospinoApiService.activateRelease(req);
    ...
    protected void initServices() {
        pospinoApiService = SpringUtils.getBean(PospinoApiService.class);
