...
public class UserGroupFilterController extends CommonDataFilterController<UserGroupFilterVM> {
    ...
    protected void initDataFilterControlActions() {
        ComboBoxUtils.initSimple(
                ...
                new SimpleComboBoxModel(UserGroupStatus.ACTIVE, translate(CommonLabel.LBL_ACTIVE)),
                new SimpleComboBoxModel(UserGroupStatus.INACTIVE, translate(CommonLabel.LBL_INACTIVE)));
    }
