package pinus.desktop.controller.doctor;
...
import pinus.desktop.service.DoctorService;
...
public class DoctorCategoryChooseController extends CommonDataChooseController<DoctorCategoryVM> {
    ...
    protected void initDataChooseControlActions() {
        ...
        tblDoctorCategory.setPlaceholder(new Label(translator.translate(CommonLabel.LBL_NO_DATA)));
        registerKeyListener();
    ...
    private void searchDoctorCategories() {
        tblDoctorCategory.setPlaceholder(new Label(translator.translate(CommonLabel.LBL_LOADING_DATA)));
